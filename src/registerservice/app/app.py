...
def register():
    if request.method == 'POST':
        ...
        if team in teams:
            return render_template('register.html', error='Team already registered! Yikes.')
        elif registered_mail in teams:
            return render_template('register.html', error='That email is already registered! Yikes.')
        else:
        ...
        # The method = GET. Display the registration form
